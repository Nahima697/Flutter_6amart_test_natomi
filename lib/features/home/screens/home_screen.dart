...
// Design system pour la nouvelle page d'accueil "Pinterest"
import 'package:sixam_mart/features/home/beyti_design_system.dart';
                  ...
                  child: ResponsiveHelper.isDesktop(context)
                      ...
                      : CustomScrollView(
                          ...
                          slivers: [
                            ...
                            /// Grille façon Pinterest — démo design system
                            SliverPadding(
                              ...
                              sliver: SliverMasonryGrid.count(
                                ...
                                // flutter_staggered_grid_view 0.7.0 : SliverMasonryGrid.count
                                // ne prend plus itemBuilder/itemCount, il faut fournir
                                // directement la liste "children".
                                children: List.generate(6, (index) {
                                  ...
                                  const prices = [12.99, 5.99, 3.99, 7.99, 4.99, 2.99];
                                  final colors = [
                                  ...
                                  return PinterestItemCard(
                                    item: PinterestDemoItem(
                                      id: index + 1,
                                      title: titles[index],
                                      price: prices[index],
                                      color: colors[index],
...
/// ---------------------------------------------------------------------
/// Démo Pinterest uniquement — renommées pour ne PAS entrer en conflit
/// avec les vraies classes `ItemModel` (features/item/domain/models)
/// et `ItemView` (common/widgets/item_view.dart) utilisées partout
/// ailleurs dans l'app.
/// ---------------------------------------------------------------------

class PinterestDemoItem {
  final int id;
  final String title;
  final double price;
  final Color color;

  PinterestDemoItem({required this.id, required this.title, required this.price, required this.color});
}

class PinterestItemCard extends StatelessWidget {
  final PinterestDemoItem item;

  const PinterestItemCard({super.key, required this.item});
